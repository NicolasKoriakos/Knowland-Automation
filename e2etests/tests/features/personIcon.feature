Feature: Person Icon
  ...
  Scenario: Search Settings
    ...
    When I click on "search_settings" element on Home Page
    When I clear "master_account_search_input" element on Account Search Page
    When I send the keys "6462" to the "master_account_search_input" element on Account Search Page
    When I click on "master_account_search_button" element on Account Search Page
    When I click on "apply_and_exit" element on Account Search Page
